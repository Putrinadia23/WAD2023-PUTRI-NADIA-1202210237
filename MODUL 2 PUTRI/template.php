...
$berat_badan = $_POST['berat_badan'] ? $_POST['berat_badan'] : "";
...
if ($tinggi_badan == "" || $berat_badan == ""||$tinggi_badan == 0 || $berat_badan == 0 ){
    $error = "Tinggi badan atau berat tidak boleh kosong";
}
...
if (empty($error)) {
    $tinggi_badan_cm = $tinggi_badan / 100;
    $bmi = $berat_badan/($tinggi_badan_cm * $tinggi_badan_cm);
